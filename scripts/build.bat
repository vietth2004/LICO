...
call mvn -T 1C clean install compile package -f ..\backend-service\git-service\pom.xml -DskipTests
call mvn -T 1C clean install compile package -f ..\processing-service\java-service\pom.xml -DskipTests
call mvn -T 1C clean install compile package -f ..\backend-service\parser-service\pom.xml -DskipTests
call mvn -T 1C clean install compile package -f ..\backend-service\project-service\pom.xml -DskipTests
call mvn -T 1C clean install compile package -f ..\processing-service\spring-service\pom.xml -DskipTests
call mvn -T 1C clean install compile package -f ..\backend-service\user-service\pom.xml -DskipTests
