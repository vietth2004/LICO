...
mvn -T 1C clean install compile package -f ./back-end-service/file-service/pom.xml -DskipTests
mvn -T 1C clean install compile package -f ./back-end-service/git-service/pom.xml -DskipTests
mvn -T 1C clean install compile package -f ./processing-service/java-service/pom.xml -DskipTests
mvn -T 1C clean install compile package -f ./back-end-service/parser-service/pom.xml -DskipTests
mvn -T 1C clean install compile package -f ./back-end-service/project-service/pom.xml -DskipTests
mvn -T 1C clean install compile package -f ./processing-service/spring-service/pom.xml -DskipTests
mvn -T 1C clean install compile package -f ./back-end-service/user-service/pom.xml -DskipTests
