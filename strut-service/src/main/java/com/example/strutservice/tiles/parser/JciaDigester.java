package com.example.strutservice.tiles.parser;
...
public class JciaDigester extends Digester {
     ...
     */
    public JciaDigester(SAXParser parser) {
     ...
     */
    public JciaDigester(XMLReader reader) {
     ...
     * prefix for difference Namespace URIs).
     */
     ...
     */
    protected Log log =
            LogFactory.getLog("com.fit.jcia.core.module.tiles.parser.JciaDigester");
    ...
    protected Log saxLog =
            LogFactory.getLog("com.fit.jcia.core.module.tiles.parser.JciaDigester.sax");
        ...
        if ((rules != null) && (rules.size() > 0)) {
            ...
            for (int i = 0; i < rules.size(); i++) {
                try {
                    ...
                    // add locator for element
                    if (locator != null && rule instanceof JciaDigesterDefinitionsReader.JciaRule) {
                        JciaLocator jciaLocator = new JciaLocator(locator.getLineNumber(), locator.getColumnNumber());
                        JciaDigesterDefinitionsReader.JciaRule jciaRule = (JciaDigesterDefinitionsReader.JciaRule) rule;
                        jciaRule.begin(namespaceURI, name, list, jciaLocator);
                    } else {
