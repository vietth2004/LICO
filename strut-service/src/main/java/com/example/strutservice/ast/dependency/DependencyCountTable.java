package com.example.strutservice.ast.dependency;
...
public class DependencyCountTable implements Serializable {
    ...
    public DependencyCountTable(Integer USE, Integer MEMBER, Integer INHERITANCE, Integer INVOCATION, Integer OVERRIDE, Integer JSF) {
        this.USE = USE;
        this.MEMBER = MEMBER;
        this.INHERITANCE = INHERITANCE;
        this.INVOCATION = INVOCATION;
