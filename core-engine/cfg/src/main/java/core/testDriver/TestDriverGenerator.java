...
public final class TestDriverGenerator {
    ...
    public static String generateTestDriver(MethodDeclaration method, Object[] testData) {
        StringBuilder result = new StringBuilder();

        result.append(generatePreSetup());

        result.append("public class TestDriver {\n");
        result.append(generateUtilities(method));
    ...
    private static String generateUtilities(MethodDeclaration method) {
        StringBuilder result = new StringBuilder();
        ...
        result.append(createCloneMethod(method));
