...
{
if (((a > 10) && MarkedPath.markOneStatement("a > 10", true, false)) || MarkedPath.markOneStatement("a > 10", false, true))
{
{
if (((c < 20) && MarkedPath.markOneStatement("c < 20", true, false)) || MarkedPath.markOneStatement("c < 20", false, true))
{
{
MarkedPath.markOneStatement("int i=0", false, false);
for (int i=0; ((i < b) && MarkedPath.markOneStatement("i < b", true, false)) || MarkedPath.markOneStatement("i < b", false, true); MarkedPath.markOneStatement("i=i + 1", false, false),
i=i + 1) {
{
MarkedPath.markOneStatement("System.out.println(\"hello\");\n", false, false);
System.out.println("hello");
}
}
if (((b < -5) && MarkedPath.markOneStatement("b < -5", true, false)) || MarkedPath.markOneStatement("b < -5", false, true))
{
{
MarkedPath.markOneStatement("System.out.println(\"bye\");\n", false, false);
...
{
MarkedPath.markOneStatement("return a + b + c;\n", false, false);
return a + b + c;
}
}
}
...
{
if (((a + b - c == 10) && MarkedPath.markOneStatement("a + b - c == 10", true, false)) || MarkedPath.markOneStatement("a + b - c == 10", false, true))
{
{
MarkedPath.markOneStatement("System.out.println(\"hehe\");\n", false, false);
System.out.println("hehe");
}
}
else {
if (((a > b) && MarkedPath.markOneStatement("a > b", true, false)) || MarkedPath.markOneStatement("a > b", false, true))
{
{
MarkedPath.markOneStatement("System.out.println(\"hoo\");\n", false, false);
...
MarkedPath.markOneStatement("return 5;\n", false, false);
return 5;
}

public static final int intsampleMethodintaintbintcTotalStatement = 14;
public static final int intsampleMethodintaintbintcTotalBranch = 12;
public static int sum(int a, int b)
{
if (((a == b) && MarkedPath.markOneStatement("a == b", true, false)) || MarkedPath.markOneStatement("a == b", false, true))
{
MarkedPath.markOneStatement("return 0;\n", false, false);
return 0;
}
if (((a > b) && MarkedPath.markOneStatement("a > b", true, false)) || MarkedPath.markOneStatement("a > b", false, true))
{
...
MarkedPath.markOneStatement("return 2;\n", false, false);
return 2;
}

public static final int intsumintaintbTotalStatement = 7;
public static final int intsumintaintbTotalBranch = 6;
