...
public static final int voidtestintaintbTotalStatement = 2;
public static final int voidtestintaintbTotalBranch = 2;
public static final int AlgorithmTotalStatement = 112;
}
