...
final class JavaOverrideBuilder {
    ...
    @Nonnull
    private final Map<MethodNode, IMethodBinding> methodBindingMap = new IdentityHashMap<>();
    // contains a set of node that already been processed
    @Nonnull
    private final Set<AbstractNode> overrideProcessedNodes = new HashSet<>();
    // contains all child method nodes of a node
    @Nonnull
    private final Map<AbstractNode, List<MethodNode>> childMethodsMap = new IdentityHashMap<>();
    // contains all methods that current method override
    @Nonnull
    private final Map<MethodNode, List<MethodNode>> methodOverridesMap = new IdentityHashMap<>();
