...
final class JavaNodeBuilder extends FileASTRequestor {
    ...
    @Nonnull
    private final Map<IBinding, AbstractNode> bindingNodeMap;
    ...
    @Nonnull
    private final JavaAnnotateBuilder annotates = new JavaAnnotateBuilder(this);
    @Nonnull
    private final JavaTypeBuilder types = new JavaTypeBuilder(this, annotates);

    @Nonnull
    private final Map<AbstractNode, Triple<Pair<InitializerNode, List<InitializerImpl>>,
            Pair<InitializerNode, List<InitializerImpl>>, List<MethodNode>>> classInitializerMap
            = new IdentityHashMap<>();

    @Nonnull
    private final Map<AbstractNode, Map<IBinding, int[]>> delayedDependencies = new LinkedHashMap<>();
    @Nonnull
