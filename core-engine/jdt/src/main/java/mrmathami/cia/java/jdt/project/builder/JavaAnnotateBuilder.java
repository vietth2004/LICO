...
final class JavaAnnotateBuilder {
    ...
    @Nonnull
    private final JavaNodeBuilder nodes;

    @Nonnull
    private final Map<IAnnotationBinding, Pair<Annotate, Map<IBinding, int[]>>> delayedAnnotations = new HashMap<>();
    @Nonnull
    private final Map<ITypeBinding, List<Annotate>> delayedAnnotationNodes = new HashMap<>();
    @Nonnull
    private final Map<IMethodBinding, List<Annotate.ParameterImpl>> delayedAnnotationParameters = new HashMap<>();
    @Nonnull
    private final Map<IBinding, List<Annotate.NodeValueImpl>> delayedAnnotationNodeValues = new HashMap<>();
