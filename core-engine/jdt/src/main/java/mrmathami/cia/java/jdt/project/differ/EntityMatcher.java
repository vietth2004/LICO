...
final class EntityMatcher {
    ...
    @Nonnull
    private final Map<JavaIdentifiedEntity, EntityWrapper> identicalCodeMap = new IdentityHashMap<>();
    @Nonnull
    private final Map<JavaIdentifiedEntity, EntityWrapper> similarCodeMap = new IdentityHashMap<>();
    @Nonnull
    private final Map<Pair<JavaIdentifiedEntity, JavaIdentifiedEntity>, int[]> matchMap = new HashMap<>();
