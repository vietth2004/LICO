...
public class JciaDomHelper {
    ...
    private static final Logger logger = LogManager.getLogger(JciaDomHelper.class);

    private static final Logger LOG = LogManager.getLogger(com.opensymphony.xwork2.util.DomHelper.class);
